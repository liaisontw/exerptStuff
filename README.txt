...
ExcerptCustomizer plugin replaces the ellipsis (...) with a 
...
== Development ==
[ExcerptCustomizer](https://github.com/liaisontw/excerptStuff)  
...
2. Search for 'Excerpt Customizer'.
3. Click Install Now, then Activate Plugin.

For manual installation via FTP:
1. Upload the 'ExcerptCustomizer' folder to the '/wp-content/plugins/' directory.
...
1. Dash-Board: Settings-Excerpt-Customizer.
2. ExcerptCustomizer_Setting_Panel
3. Before-ExcerptCustomizer.
4. After-ExcerptCustomizer.
