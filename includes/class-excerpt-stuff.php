...
class Excerpt_Stuff {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Excerpt_Stuff_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		if ( defined( 'EXCERPT_STUFF_VERSION' ) ) {
			$this->version = EXCERPT_STUFF_VERSION;
		} else {
			$this->version = '1.0.0';
		}
	 ...
	 *
	 * - Excerpt_Stuff_Loader. Orchestrates the hooks of the plugin.
	 * - Excerpt_Stuff_i18n. Defines internationalization functionality.
	 * - Excerpt_Stuff_Admin. Defines all hooks for the admin area.
	 * - Excerpt_Stuff_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the Excerpt_Stuff_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Excerpt_Stuff_Admin( $this->get_plugin_name(), $this->get_version() );
	 ...
	 *
	 * @since     1.0.0
	 * @return    Excerpt_Stuff_Loader    Orchestrates the hooks of the plugin.
	 */
